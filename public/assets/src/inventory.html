              ...
              <tbody>
                <tr class="align-middle ">
                  <td><a href=""><img src="./assets/images/product-1.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">Gaming Joy Stick</span></a>
                  </td>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="./assets/images/product-2.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">Wireless Earphones</span></a>
                  </td>
                  <td>PRD002</td>
                  <td>Electronics</td>
                  <td>Tech Pro</td>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="./assets/images/product-3.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">Smart Watch Pro</span></a>
                  </td>
                  <td>PRD003</td>
                  <td>Electronics</td>
                  <td>Tech Pro</td>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="./assets/images/product-4.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">USB-C Fast Charger</span></a>
                  </td>
                  <td>PRD004</td>
                  <td>Electronics</td>
                  <td>Tech Pro</td>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="./assets/images/product-6.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">Magic Keyboard</span></a>
                  </td>
                  <td>PRD006</td>
                  <td>Electronics</td>
                  <td>Tech Pro</td>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="./assets/images/product-7.png" alt=""
                        class="avatar avatar-md rounded" /><span class="ms-3">MacBook Pro 16"</span></a>
                  </td>
                  <td>PRD007</td>
                  <td>Electronics</td>
                  <td>Tech Pro</td>
