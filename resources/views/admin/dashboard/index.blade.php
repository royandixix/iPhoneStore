        ...
        <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/dist/assets/images/' . $p['img']) }}" class="rounded" width="48">
                    <div class="flex-grow-1">
                        <p class="mb-1">{{ $p['name'] }}</p>
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <small class="fw-semibold">{{ $p['price'] }}</small>
                            <small>•</small>
                            <small>{{ $p['units'] }} Unit</small>
                        </div>
                    </div>
                    <span class="badge bg-{{ $p['badge'] }}-subtle text-{{ $p['badge'] }} border border-{{ $p['badge'] }}">{{ $p['pct'] }}</span>
                </li>
                @endforeach
            </ul>
        </div>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <span class="fw-semibold text-primary">{{ $p['stock'] }}</span>
    ...
    <div class="col-lg-4">
        <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/dist/assets/images/' . $s['img']) }}" class="rounded" width="48">
                    <div class="flex-grow-1">
                        <p class="mb-1">{{ $s['name'] }}</p>
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <small class="fw-semibold">{{ $s['cat'] }}</small>
                            <small>•</small>
                            <small>{{ $s['price'] }}</small>
                        </div>
                    </div>
                    <span class="badge bg-{{ $s['status'] }}-subtle text-{{ $s['status'] }}">{{ $s['label'] }}</span>
                </li>
                @endforeach
            </ul>
        </div>
