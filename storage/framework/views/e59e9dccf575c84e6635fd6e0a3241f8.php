        ...
        <ul class="list-unstyled d-flex align-items-center mb-0 gap-1">
            ...
            <li class="ms-3 dropdown">
                <a href="#" data-bs-toggle="dropdown">
                    <img src="<?php echo e(asset('assets/dist/assets/images/avatar-1.jpg')); ?>"
                ...
                <div class="dropdown-menu dropdown-menu-end p-0" style="min-width:200px;">
                    ...
                    <div class="d-flex gap-3 align-items-center border-bottom px-3 py-3">
                        ...
                        <div>
                            <h4 class="mb-0 small"><?php echo e(auth()->user()->name); ?></h4>
                            <p class="mb-0 small text-muted"><?php echo e(auth()->user()->email); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 d-flex flex-column gap-2 small">
                        ...
                        <a href="<?php echo e(route('admin.profile.index')); ?>" class="text-decoration-none">
...
<?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/partials/navbar.blade.php ENDPATH**/ ?>