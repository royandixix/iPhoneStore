...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <div>
                <a href="<?php echo e(route('admin.products.handphone.create')); ?>" class="btn btn-primary">
                    Tambah Produk
                </a>
            </div>
        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="align-middle">
                                ...
                                <td class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('admin.products.handphone.edit', $product->id)); ?>">
                                        <i class="ti ti-edit"></i>
                                    </a>

                                    <form action="<?php echo e(route('admin.products.handphone.destroy', $product->id)); ?>"
                                        method="POST"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/products/handphone/index.blade.php ENDPATH**/ ?>