        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between border-bottom pb-4 mb-3">
                    <div>
                        <h3 class="fw-bold h4">
                            Rp <?php echo e(number_format(\App\Models\Order::sum('total'), 0, ',', '.')); ?>
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between border-bottom pb-4 mb-3">
                    <div>
                        <h3 class="fw-bold h4">
                            <?php echo e(\App\Models\Order::where('status','completed')->count()); ?>
...
</div><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/penjualan/components/stats.blade.php ENDPATH**/ ?>