            ...
            <div class="col-12">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                    <div>
                        ...
                        <p class="mb-0">Kelola produk accessories kamu</p>
                    </div>
                    <div>
                        <a href="<?php echo e(route('admin.products.accessories.index')); ?>" class="btn btn-primary">
                            Kembali ke Produk
                        </a>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="<?php echo e(route('admin.products.accessories.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('admin.products.accessories.index')); ?>" class="btn btn-secondary">
                                    Batal
                                </a>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/products/accessories/create.blade.php ENDPATH**/ ?>