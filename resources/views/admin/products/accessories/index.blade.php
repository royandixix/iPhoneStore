...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <div>
                <a href="{{ route('admin.products.accessories.create') }}" class="btn btn-primary">
                    Tambah Produk
                </a>
            </div>
        </div>
                        ...
                        @forelse ($products as $product)
                            <tr class="align-middle">
                                ...
                                <td class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.products.accessories.edit', $product->id) }}">
                                        <i class="ti ti-edit"></i>
                                    </a>

                                    <form action="{{ route('admin.products.accessories.destroy', $product->id) }}"
                                        method="POST"
