...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadStats() {
        fetch("<?php echo e(route('admin.products.stats')); ?>")
            .then(res => res.json())
            .then(data => {
    ...
    function loadTopProducts() {
        fetch("<?php echo e(route('admin.products.top')); ?>")
            .then(res => res.json())
            .then(products => {
    ...
    function loadSalesChart() {
        fetch("<?php echo e(route('admin.products.salesData')); ?>")
            .then(res => res.json())
            .then(data => {
...
</script><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/components/product-stats.blade.php ENDPATH**/ ?>