<aside id="sidebar" class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            ...
            <div class="collapse <?php echo e(request()->routeIs('admin.products.*') ? 'show' : ''); ?>"
                 id="productsMenu">
...
</style><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>