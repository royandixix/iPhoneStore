                ...
                <form action="<?php echo e(route('admin.settings.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <img id="preview-image"
                             src="<?php echo e(auth()->user()->photo ? asset('storage/' . auth()->user()->photo) : 'https://via.placeholder.com/120'); ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="address" class="form-control" rows="3"><?php echo e(old('address', auth()->user()->address)); ?></textarea>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Downloads/penjualan-iphone/resources/views/admin/settings/profile.blade.php ENDPATH**/ ?>